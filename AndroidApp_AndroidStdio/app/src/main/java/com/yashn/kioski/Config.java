...
public class Config {
    ...
    public static final Object[] TITLES = new Object[]{"AirPrint"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"http://kioski.pe.hu/wp-login.php"};
    ...
    public static String ANALYTICS_ID = "xxxxx";
